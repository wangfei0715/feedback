										...
										<dd id="<s:property value="messageid" />_detaildiv" style="display:none;" class="opt-repay">
											<ul class="con-repay-list clearfix">
												<li>
													...
													<div class="user-head-s"><img width="65" height="65" src="<%=basePath %>common/images/user/
...
<!--										<div id="<s:property value="messageid" />_detaildiv" style="display:none;">-->
<!--											<s:property value="title" />-->
<!--											<s:property value="content" />-->
<!--										</div>-->
										</s:iterator>
<!--										<dd class="opt-repay" style="display: none" id="opt_114434"></dd>-->
									</dl>
								</div>
							</div>
...
function filt(opt){
	...
	// alert(type);
	// alert(status);
	var href = "<%=basePath %>message/message_getMyQuestions.action";
